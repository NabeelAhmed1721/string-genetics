...
export class Gene {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Gene.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_gene_free(ptr);
    }
    /**
    * @param {string} dna_init
    */
    constructor(dna_init) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(dna_init, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.gene_new(retptr, ptr0, len0);
    ...
    */
    get dna() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.gene_dna(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    /**
    * @param {string} dna_edit
    */
    set setDNA(dna_edit) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(dna_edit, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.gene_set_setDNA(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    toString() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.gene_toString(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    calcFitness(target) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(target, Gene);
            wasm.gene_calcFitness(retptr, this.__wbg_ptr, target.__wbg_ptr);
    ...
    */
    crossover(partner) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(partner, Gene);
            wasm.gene_crossover(retptr, this.__wbg_ptr, partner.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    mutate(rate) {
        wasm.gene_mutate(this.__wbg_ptr, rate);
    }
    /**
    * @returns {number}
    */
    len() {
        const ret = wasm.gene_len(this.__wbg_ptr);
        return ret >>> 0;
    }
}
/**
...
export class Pool {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Pool.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_pool_free(ptr);
    }
    /**
    * @param {Gene} target
    * @param {number} pool_size
    */
    constructor(target, pool_size) {
        _assertClass(target, Gene);
        var ptr0 = target.__destroy_into_raw();
        const ret = wasm.pool_new(ptr0, pool_size);
        return Pool.__wrap(ret);
    }
    /**
    */
    naturalSelection() {
        wasm.pool_naturalSelection(this.__wbg_ptr);
    }
    /**
    * @returns {Gene}
    */
    getBest() {
        const ret = wasm.pool_getBest(this.__wbg_ptr);
        return Gene.__wrap(ret);
    }
}
